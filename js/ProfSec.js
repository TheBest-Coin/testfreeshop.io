...
async function telebot() {
      ...
      if (fixedPoint <= PneedZOK) {
        ...
        BuyChannelAd.onclick = function () {
          ...
          async function AdInserting() {
            let { data: telusersinfo2, error3 } = await _supabase
              .from('telusersinfo')
              .select('*')
              .eq('id', a)
              .single();
            ...
            const { data2, error2 } = await _supabase.from("telusersinfo")
    ...
    if (reffrall <= "1" && points1 >= 5.1) {
      ...
      ClaimRefBtn.addEventListener('click', () => {
        ...
        async function ReffOkRun() {
          let { data: FindFriend, error } = await _supabase
            .from('telusersinfo')
            .select('*')
            .eq('id', FriendFind)
            .single();
          ...
          async function FriendRewardedOk() {
            ...
            const { data2, error2 } = await _supabase.from("telusersinfo")
              ...
              .eq('id', a)
            // my Ref Change
            const { data3, error3 } = await _supabase.from("telusersinfo")
  ...
  if (info.rank == "Silver") {
    ...
    async function ShopSilverRank() {
      const { data: SilverRank, error } = await _supabase
        .from('SilverRank')
        .select('*')
            ...
            if (Name110.value.length > 1 && Email110.value.length > 4 && Id110.value.length > 5) {
              ...
              async function Shop110Gem() {
                ...
                if (user_Point >= PNeed110Gem) {
                  ...
                  const { data, error } = await _supabase.from("telusersinfo")
                  ...
                  if (error) {
                    ...
                    const { data110, error110 } = await _supabase
                      .from('ShopFactor')
                      .insert([
                        {
              ...
              async function Shop221Gem() {
                ...
                if (user_Point >= PNeedGem) {
                  ...
                  if (error) {
                    ...
                    // shop 110Gem FreeFire Ok 
                    document.getElementById('FormSec').className = 'formHiden';
                    const { data221, error221 } = await _supabase
                      .from('ShopFactor')
                      .insert([
                        {
              ...
              async function Shop530Gem() {
                ...
                if (user_Point >= PNeedGem) {
                  ...
                  if (error) {
                    ...
                    // shop 110Gem FreeFire Ok 
                    document.getElementById('FormSec').className = 'formHiden';
                    const { data530, error530 } = await _supabase
                      .from('ShopFactor')
                      .insert([
                        {
              ...
              async function Shop1188Gem() {
                ...
                if (user_Point >= PNeedGem) {
                  ...
                  if (error) {
                    ...
                    // shop 110Gem FreeFire Ok 
                    document.getElementById('FormSec').className = 'formHiden';
                    const { data1188, error1188 } = await _supabase
                      .from('ShopFactor')
                      .insert([
                        {
              ...
              async function Shop2200Gem() {
                ...
                if (user_Point >= PNeedGem) {
                  ...
                  if (error) {
                    ...
                    // shop 110Gem FreeFire Ok 
                    document.getElementById('FormSec').className = 'formHiden';
                    const { data2200, error2200 } = await _supabase
                      .from('ShopFactor')
                      .insert([
                        {
              ...
              async function ShopUC60() {
                ...
                if (user_Point >= PNeedGem) {
                  ...
                  if (error) {
                    ...
                    // shop UC60 PUBG Ok 
                    document.getElementById('FormSec').className = 'formHiden';
                    const { dataUC60, errorUC60 } = await _supabase
                      .from('ShopFactor')
                      .insert([
                        {
              ...
              async function Shop325UC() {
                ...
                if (user_Point >= PNeedGem) {
                  ...
                  if (error) {
                    ...
                    // shop UC60 PUBG Ok 
                    document.getElementById('FormSec').className = 'formHiden';
                    const { data325UC, error325UC } = await _supabase
                      .from('ShopFactor')
                      .insert([
                        {
              ...
              async function Shop660UC() {
                ...
                if (user_Point >= PNeedGem) {
                  ...
                  if (error) {
                    ...
                    // shop UC60 PUBG Ok 
                    document.getElementById('FormSec').className = 'formHiden';
                    const { data660UC, error660UC } = await _supabase
                      .from('ShopFactor')
                      .insert([
                        {
              ...
              async function ShopSilverAccount() {
                ...
                if (user_Point >= PNeedGem) {
                  ...
                  if (error) {
                    ...
                    document.getElementById('FormSec').className = 'formHiden';
                    const { dataDiamondAccount, errorDiamondAccount } = await _supabase
                      .from('ShopFactor')
                      .insert([
                        {
              ...
              async function Shop15TRC20() {
                ...
                if (user_Point >= PNeedGem) {
                  ...
                  if (error) {
                    ...
                    // shop 15TRC20 Ok 
                    document.getElementById('FormSec').className = 'formHiden';
                    const { data15TRC20, error15TRC20 } = await _supabase
                      .from('ShopFactor')
                      .insert([
                        {
              ...
              async function Shop50TRC20() {
                ...
                if (user_Point >= PNeedGem) {
                  ...
                  if (error) {
                    ...
                    // shop 50TRC20 Ok 
                    document.getElementById('FormSec').className = 'formHiden';
                    const { data50TRC20, error50TRC20 } = await _supabase
                      .from('ShopFactor')
                      .insert([
                        {
    ...
    async function ShopGoldenRank() {
      const { data: GoldenRank, error } = await _supabase
        .from('GoldenRank')
        .select('*')
      if (error) {
        console.log('error :', error);
    ...
    async function ShopDiamondRank() {
      const { data: DiamondRank, error } = await _supabase
        .from('DiamondRank')
        .select('*')
      if (error) {
        console.log('error :', error);
